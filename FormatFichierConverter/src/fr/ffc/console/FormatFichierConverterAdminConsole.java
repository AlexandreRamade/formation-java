...
import fr.fcc.utils.LireFichier;
...
public class FormatFichierConverterAdminConsole {
	...
	public static void main(String[] args) {
		...
		String commandeUser = "converter C:\\Users\\Formation\\Documents\\Test\\json.json C:\\Users\\Formation\\Documents\\Test\\";
		...
		try {
			...
			if(sousComUser[1].matches("-o")) {
				if(!SelectFormatUtil.selectFormat(ff, sousComUser[2], SelectFormatUtil.OUTPUT_FORMAT)) {
